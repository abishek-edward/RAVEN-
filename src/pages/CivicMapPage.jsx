...
export default function CivicMapPage() {
  const { navigateTo, selectedClusterId, setSelectedClusterId } = useRaven();
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-200">
        <div>
          ...
          >
            ...
            Back to Civic Issues Directory
          </button>
          ...
          <p className="text-xs text-slate-600 mt-1">
            Geographic distribution of correlated everyday civic issue clusters. Numeric pins denote the AI-Assisted Priority Score.
          </p>
        </div>
